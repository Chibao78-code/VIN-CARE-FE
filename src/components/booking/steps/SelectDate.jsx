...
const SelectDate = ({ data, onNext, onBack }) => {
  ...
  maxDate.setDate(maxDate.getDate() + 30); // 30 ngay toi
      ...
      <div className="space-y-4">
        <div>
          ...
          {selectedDate && (
            <div className="mt-2">
              <p className="text-sm text-gray-600">
                Bạn đã chọn: <span className="font-medium text-gray-900">
                  {getDayOfWeek(selectedDate)}, ngày {formatDisplayDate(selectedDate)}
                </span>
              </p>
        ...
        <div className="p-4 bg-amber-50 rounded-lg">
          ...
          <ul className="text-sm text-amber-700 space-y-1">
            ...
            <li>• Có thể đặt lịch tối đa 30 ngày từ hôm nay</li>
            <li>• Nếu cần hẹn gấp, vui lòng gọi hotline: {data.center?.phone}</li>
          </ul>
        </div>
      </div>
